...
Private Sub cmdCari_Click()
    ...
    strFilter = strFilter & " and Kelas like '%" & dcKelas.Text & "%' and JenisPelayanan like '%" & dcJenisPelayanan.Text & "%' and NamaPelayanan like '%" & dcNamaPelayanan.Text & "%' and DokterOperator Like '%" & dcNamaDokter.Text & "%' and JenisPasien like '%" & dcJenisPasien.Text & "%' and KdRuangan='" & mstrKdRuangan & "'"
