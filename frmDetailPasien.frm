...
Private Sub sp_DetailPasien(ByVal adoCommand As ADODB.Command)
    ...
    With adoCommand
        ...
        .Parameters.Append .CreateParameter("NoKK", adVarChar, adParamInput, 30, Null)
        .Parameters.Append .CreateParameter("NamaKepalaKeluarga", adVarChar, adParamInput, 30, Null)
