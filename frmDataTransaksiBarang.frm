...
Begin VB.Form frmDataTransaksiBarang 
   BorderStyle     =   1  'Fixed Single
   Caption         =   " Rekapitulasi Transaksi Barang Medis"
   ClientHeight    =   8445
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   14790
   ...
   EndProperty
   Icon            =   "frmDataTransaksiBarang.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.Image Image2 
      Height          =   945
      Left            =   12960
      Picture         =   "frmDataTransaksiBarang.frx":0CCA
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1875
   End
   Begin VB.Image Image3 
      Height          =   975
      Left            =   0
      Picture         =   "frmDataTransaksiBarang.frx":1A52
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1800
   End
   Begin VB.Image Image1 
      Height          =   975
      Left            =   1800
      Picture         =   "frmDataTransaksiBarang.frx":4413
      Stretch         =   -1  'True
      Top             =   0
      Width           =   12975
   End
End
Attribute VB_Name = "frmDataTransaksiBarang"
...
Private Sub dgDataTransaksiBarang_KeyPress(KeyAscii As Integer)
