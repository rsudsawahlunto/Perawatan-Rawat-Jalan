...
Begin VB.Form frmCatatanMedikPasien 
   ...
   Begin VB.Frame fraCatatanMedis 
      ...
      Top             =   2280
      Width           =   9495
      Begin VB.TextBox txtCatatanMedisKeluarga 
         Appearance      =   0  'Flat
         Height          =   615
         Left            =   2040
         MaxLength       =   1000
      ...
      Begin MSDataListLib.DataCombo dcImunisasi 
         ...
         Text            =   ""
      End
      Begin MSDataListLib.DataCombo dcAlergi 
         Height          =   330
         Left            =   2040
         TabIndex        =   25
         Top             =   1240
      ...
      Begin VB.Label Label10 
         Caption         =   "Catatan Medis Keluarga"
         Height          =   255
         Left            =   2040
         TabIndex        =   39
         Top             =   4560
   ...
   Begin VB.Image Image2 
      Height          =   945
      Left            =   7680
      Picture         =   "frmCatatanMedikPasien.frx":368B
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1875
   End
...
Dim intJmlDokterAlergi As Integer
Public BoolUbahAlergiCatatanMedikPasien As Boolean
...
Private Sub cmdSimpan_Click()
    ...
    If mstrKdDokter = "" Then
        MsgBox "Dokter Pemeriksa harus diisi", vbCritical
        txtDokter.SetFocus
        Exit Sub
    End If
    
    If txtKeluhanUtama.Text = "" Then
        MsgBox "Keluhan Utama harus diisi", vbCritical
        txtKeluhanUtama.SetFocus
        Exit Sub
    End If
    
    If txtPengobatan.Text = "" Then
        MsgBox "Pengobatan harus diisi", vbCritical
        txtPengobatan.SetFocus
        Exit Sub
    End If
    ...
    If dcAlergi.Text <> "" Then
        Call sp_Alergi(adoComm)
    End If
...
Private Sub dcAlergi_KeyPress(KeyAscii As Integer)
If KeyAscii = 13 Then txtKeluhanUtama.SetFocus
End Sub

Private Sub dcImunisasi_KeyPress(KeyAscii As Integer)
If KeyAscii = 13 Then dcTriase.SetFocus
End Sub
...
Private Sub dgDokterAlergi_Click()
'    Call dgDokterAlergi_KeyPress(13)
End Sub
...
'    If rs.EOF = False Then dcImunisasi.BoundText = rs(0).Value
    ...
    strSQL = "Select kdAlergi, NamaAlergi from Alergi where StatusEnabled = '1' order by NamaAlergi"
    Call msubDcSource(dcAlergi, rs, strSQL)
'    If rs.EOF = False Then dcAlergi.BoundText = rs(0).Value
...
Private Sub txtCatatanMedisKeluarga_KeyPress(KeyAscii As Integer)
    If KeyAscii = 13 Then cmdSimpan.SetFocus
    Call SetKeyPressToCharToNumber(KeyAscii)
End Sub
...
Private Sub txtKeterangan_KeyPress(KeyAscii As Integer)
    If KeyAscii = 13 Then txtCatatanMedisKeluarga.SetFocus
    Call SetKeyPressToCharToNumber(KeyAscii)
End Sub
...
Private Sub sp_CatatanMedisRJ(ByVal adoCommand As ADODB.Command)
    ...
    With adoCommand
        ...
        .Parameters.Append .CreateParameter("KeluhanUtama", adVarChar, adParamInput, 1000, IIf(txtKeluhanUtama.Text = "", Null, txtKeluhanUtama.Text))
        .Parameters.Append .CreateParameter("RiwayatMedisKeluarga", adVarChar, adParamInput, 1000, IIf(txtCatatanMedisKeluarga.Text = "", Null, txtCatatanMedisKeluarga.Text))
        .Parameters.Append .CreateParameter("KdImunisasi", adChar, adParamInput, 3, IIf(dcImunisasi.Text = "", Null, dcImunisasi.BoundText))
        .Parameters.Append .CreateParameter("Pengobatan", adVarChar, adParamInput, 1000, IIf(txtPengobatan.Text = "", Null, txtPengobatan.Text))
        .Parameters.Append .CreateParameter("Keterangan", adVarChar, adParamInput, 1000, IIf(txtKeterangan.Text = "", Null, txtKeterangan.Text))
        ...
        .Parameters.Append .CreateParameter("KdAlergi", adChar, adParamInput, 2, IIf(dcAlergi.BoundText = "", Null, dcAlergi.BoundText))
