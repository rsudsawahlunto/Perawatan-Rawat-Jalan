...
Begin VB.Form frmDataKehamilandanKB 
   ...
   Caption         =   "Data Kehamilan dan Keluarga Berencana Pasien"
   ClientHeight    =   8970
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin TabDlg.SSTab ssData 
      ...
      Tab(0).Control(1)=   "fraDokterKehamilan"
   ...
   Begin VB.Image Image2 
      Height          =   945
      Left            =   7680
      Picture         =   "frmDataKehamilandanKB.frx":36C3
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1875
   End
...
Private Function sp_DelCatatanKehamilanPasien() As Boolean
    ...
    With dbcmd
        ...
        .CommandText = "Del_CatatanKehamilanPasien"
...
Private Function sp_DelCatatanProgramKBPasien() As Boolean
    ...
    With dbcmd
        ...
        .ActiveConnection = dbConn
        .CommandText = "Del_CatatanProgramKBPasien"
        .CommandType = adCmdStoredProc
        .Execute
...
Private Sub subLoadDcSource()
    ...
    'data kehamilan
    strSQL = "SELECT KdImunisasi, NamaImunisasi From Imunisasi ORDER BY NamaImunisasi"
    ...
    strSQL = "SELECT KdJenisKontrasepsi, JenisKontrasepsi From JenisKontrasepsi ORDER BY JenisKontrasepsi"
...
Private Function sp_CatatanKehamilanPasien() As Boolean
    ...
    With dbcmd
        ...
        .Parameters.Append .CreateParameter("KdImunisasi", adChar, adParamInput, 3, IIf(dcImunisasi.BoundText = "", Null, dcImunisasi.BoundText))
        ...
        .ActiveConnection = dbConn
        .CommandText = "AU_CatatanKehamilanPasien"
        .CommandType = adCmdStoredProc
        .Execute
...
Private Function sp_CatatanProgramKBPasien() As Boolean
    ...
    With dbcmd
        ...
        .Parameters.Append .CreateParameter("EfekSamping", adVarChar, adParamInput, 200, IIf(Trim(txtEfekSamping.Text) = "", Null, Trim(txtEfekSamping.Text)))
        ...
        .ActiveConnection = dbConn
        .CommandText = "AU_CatatanProgramKBPasien"
        .CommandType = adCmdStoredProc
        .Execute
...
Private Sub subSimpanKehamilan()
    ...
    If Trim(txtKdDokterKehamilan.Text) = "" Then
        ...
        Exit Sub
    End If
    If txtBulanKehamilan.Text <= 0 And txtHariKehamilan.Text <= 0 Then
'        If txtHariKehamilan.Text <= 0 Then
            MsgBox "Minimal 1 Bulan / 1 hari", vbInformation, "information"
...
Private Sub dcPerawatKB_KeyPress(KeyAscii As Integer)
    ...
    If KeyAscii = 13 Then
        If Len(Trim(dcPerawatKB.Text)) > 0 Then
            ...
            " WHERE ([Nama Pemeriksa] LIKE '%" & dcPerawatKB.Text & "%') order by [Nama Pemeriksa]"
            Call msubRecFO(rs, strSQL)
            dcPerawatKB.Text = ""
...
Private Sub dcPerawatKehamilan_KeyPress(KeyAscii As Integer)
    ...
    If KeyAscii = 13 Then
        If Len(Trim(dcPerawatKehamilan.Text)) > 0 Then
            strSQL = "SELECT  IdPegawai, [Nama Pemeriksa]" & _
            " From V_DaftarPemeriksaPasien" & _
            " WHERE ([Nama Pemeriksa] LIKE '%" & dcPerawatKehamilan.Text & "%')order by [Nama Pemeriksa]"
            Call msubRecFO(rs, strSQL)
...
Private Sub dgDokterKB_KeyUp(KeyCode As Integer, Shift As Integer)
    If KeyCode = vbKeyEscape Then
        If dgDokterKB.Visible = False Then Exit Sub
        txtPemeriksaKB.SetFocus
    End If
End Sub
...
Private Sub dgDokterKehamilan_KeyUp(KeyCode As Integer, Shift As Integer)
    If KeyCode = vbKeyEscape Then
        If dgDokterKehamilan.Visible = False Then Exit Sub
        txtPemeriksaKehamilan.SetFocus
    End If
End Sub

Private Sub dgKB_KeyPress(KeyAscii As Integer)
    If KeyAscii = 13 Then cmdHapus.SetFocus
End Sub

Private Sub dgKehamilan_KeyPress(KeyAscii As Integer)
    If KeyAscii = 13 Then cmdHapus.SetFocus
End Sub
...
Private Sub Form_Load()
    ...
    txtPemeriksaKehamilan.Text = mstrNamaDokter
    txtKdDokterKehamilan.Text = mstrKdDokter
    fraDokterKehamilan.Visible = False
'    txtPemeriksaKB.Text = mstrNamaDokter
'    txtKdDokterKB.Text = mstrKdDokter
'    fraDokterKB.Visible = False
...
Private Sub ssData_Click(PreviousTab As Integer)
    ...
    txtKdDokterKehamilan.Text = mstrKdDokter
    fraDokterKehamilan.Visible = False
    dcPerawatKehamilan.BoundText = strIDPegawai
    txtPemeriksaKB.Text = mstrNamaDokter
    txtKdDokterKB.Text = mstrKdDokter
    fraDokterKB.Visible = False
    dcPerawatKB.BoundText = strIDPegawai
    Exit Sub
errLoad:
    Call msubPesanError
End Sub
...
Private Sub txtBulanKehamilan_Change()
    ...
    If Len(txtBulanKehamilan.Text) > 2 Then
        MsgBox "Bulan Hanya 2 Digit ", vbOKOnly + vbInformation, "Validasi"
        txtBulanKehamilan.Text = 0
    Else
