...
Begin VB.Form frmPOAKaryawan 
   ...
   Caption         =   " Pemakaian Obat & Alkes Karyawan"
   ClientHeight    =   6510
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   10950
   ...
   Begin VB.Image Image1 
      Height          =   975
      Left            =   1800
      Picture         =   "frmPOAKaryawan.frx":5055
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9495
   End
...
Private Sub dgData_KeyPress(KeyAscii As Integer)
    If KeyAscii = 13 Then btnHapus.SetFocus
End Sub
...
Private Sub dgHargaBrg_KeyPress(KeyAscii As Integer)
    ...
    End If
a:
    MsgBox "Barang Tidak Ada", vbCritical, "Validasi"
End Sub

Private Sub dgHargaBrg_KeyUp(KeyCode As Integer, Shift As Integer)
    If KeyCode = vbKeyEscape Then
