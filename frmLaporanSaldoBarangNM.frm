...
Begin VB.Form frmLaporanSaldoBarangNM 
   ...
   EndProperty
   Icon            =   "frmLaporanSaldoBarangNM.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.Image Image2 
      Height          =   945
      Left            =   7440
      Picture         =   "frmLaporanSaldoBarangNM.frx":0CCA
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1875
   End
   Begin VB.Image Image3 
      Height          =   975
      Left            =   0
      Picture         =   "frmLaporanSaldoBarangNM.frx":1A52
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1800
   End
   ...
   Begin VB.Image Image1 
      Height          =   975
      Left            =   1800
      Picture         =   "frmLaporanSaldoBarangNM.frx":4413
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9495
   End
End
Attribute VB_Name = "frmLaporanSaldoBarangNM"
...
Private Sub chkNamaBarang_Click()
    If chkNamaBarang.Value = vbChecked Then
        ...
        Call msubDcSource(dcNamaBarang, rs, "SELECT KdBarang, NamaBarang FROM MasterBarangNonMedis ORDER BY NamaBarang")
    Else
...
Private Sub dcGroup_GotFocus()
    ...
    ElseIf optAsalBarang.Value = True Then
        Call msubDcSource(dcGroup, rs, "SELECT KdAsal, NamaAsal FROM AsalBarang where kdinstalasi='05'  ORDER BY NamaAsal")
    ElseIf optJenisBarang.Value = True Then
