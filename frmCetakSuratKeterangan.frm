...
Dim rptSuratKeterangan As New crSuratKeterangan
...
Private Sub Form_Load()
    ...
    With rptSuratKeterangan
        ...
        .txtNIP.SetText (frmSuratKeterangan.txtNIP.Text)
        ...
        .txtTinggi.SetText (frmSuratKeterangan.txtTinggi.Text) & " Cm "
        .txtBerat.SetText (frmSuratKeterangan.txtBerat.Text) & " Kg "
        .txtGolDarah.SetText (frmSuratKeterangan.dcGolDarah.Text)
        .txtTekDarah.SetText (frmSuratKeterangan.txtTekanan.Text)
        .txtTekDarah2.SetText (frmSuratKeterangan.txtTekanan2.Text)
        .txtKeperluan.SetText (frmSuratKeterangan.txtKeperluan.Text)
