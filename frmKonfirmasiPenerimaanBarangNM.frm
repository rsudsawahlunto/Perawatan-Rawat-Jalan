...
Begin VB.Form frmKonfirmasiPenerimaanBarangNM 
   ...
   EndProperty
   Icon            =   "frmKonfirmasiPenerimaanBarangNM.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VB.Image Image2 
      Height          =   945
      Left            =   10680
      Picture         =   "frmKonfirmasiPenerimaanBarangNM.frx":0CCA
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1875
   End
   Begin VB.Image Image1 
      Height          =   975
      Left            =   1800
      Picture         =   "frmKonfirmasiPenerimaanBarangNM.frx":1A52
      Stretch         =   -1  'True
      Top             =   0
      Width           =   10695
   End
...
'    If Val(fgData.TextMatrix(fgData.Row, 4)) = "" Then MsgBox "Jumlah terima harus diisi", vbExclamation, "Validasi": Exit Sub
    ...
    If mstrKdKelompokBarang = "01" Then
        For i = 1 To fgData.Rows - 1
        With fgData
            If sp_DetailTerimaBarangRuanganNM(.TextMatrix(i, 6), .TextMatrix(i, 7), .TextMatrix(i, 3), .TextMatrix(i, 4), .TextMatrix(i, 9), .TextMatrix(i, 8), .TextMatrix(i, 5)) = False Then Exit Sub
        End With
    Next i
...
Dim i As Integer
    If KeyAscii = 13 Then
        Select Case fgData.Col
            ...
            Case 6
                If KeyAscii = 13 Then
                    fgData.TextMatrix(fgData.Row, 9) = txtIsi.Text
