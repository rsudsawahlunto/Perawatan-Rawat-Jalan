...
Private Sub cmdTambah_Click()
    ...
    If (Val(txtStock.Text) < 1) Then
        MsgBox "Jumlah barang Tidak Mencukupi"
        Exit Sub
    End If
'cek max stok
If dcStatusBarang.BoundText = "02" Then
...
Private Sub subLoadDcSource()
    ...
    Call msubDcSource(dcStatusBarang, rs, "SELECT KdKelompokBarang, KelompokBarang FROM KelompokBarang Where StatusEnabled=1 ORDER BY KelompokBarang")
