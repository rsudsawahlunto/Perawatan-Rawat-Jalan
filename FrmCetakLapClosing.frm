...
Begin VB.Form FrmCetakLapClosing 
   Caption         =   "Cetak Lap Closing"
   ClientHeight    =   7080
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   5865
   Icon            =   "FrmCetakLapClosing.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   7080
   ScaleWidth      =   5865
   ...
   End
End
Attribute VB_Name = "FrmCetakLapClosing"
...
Dim report3 As New CrDaftarJumlahPasien
...
Private Sub Form_Load()
    ...
    Set report3 = New CrDaftarJumlahPasien
