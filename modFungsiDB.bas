...
Public Function f_AMRekapitulasiKomponenRemunerasiDokter(fNoBKM As String, fNoStruk As String, fNoPendaftaran As String, fKdRuangan As String, fKdPelayananRS As String, fKdKomponenR As String, fKdDetailKomponenR As String, fTglPelayanan As Date, fIdPegawai As Variant, fJmlPelayanan As Integer, fTarif As Currency, fJmlBayar As Currency, fJmlHutangPenjamin As Currency, fJmlTanggunganRS As Currency, fJmlPembebasan As Currency, fSisaTagihan As Currency, fKdDetailJenisJasaPelayanan As String, fKdKelas As String, fNoLab_Rad As Variant, fKdAsal As String, fKdSubInstalasi As String, fStatus As String)
    'Public Function f_AMRekapitulasiKomponenRemunerasiDokter(fNoBKM As String, fNoStruk As String, fNoPendaftaran As String, fKdRuangan As String, fKdPelayananRS As String, fKdKomponenR As String, fKdDetailKomponenR As String, fTglPelayanan As Date, fIdPegawai As Variant, fJmlPelayanan As Double, fTarif As Currency, fJmlBayar As Currency, fJmlHutangPenjamin As Currency, fJmlTanggunganRS As Currency, fJmlPembebasan As Currency, fSisaTagihan As Currency, fKdDetailJenisJasaPelayanan As String, fKdKelas As String, fNoLab_Rad As Variant, fKdAsal As String, fKdSubInstalasi As String, fStatus As String)
    'fStatus : A=Tambah; M=Minus
    Dim fTglBKM As Date
    Dim fTotalTarif As Currency
    Dim fJmlBayarTotal As Currency
...
Public Function f_AddRekapKomponenBiayaPelayananApotik(fNoBKM As String, fNoStruk As String, fTotalBiayaHrsDibayar As Currency, fJmlBayar As Currency, fJmlPembebasan As Currency, fSisaTagihan As Currency)
    ...
    While fRS.EOF = False
        ...
        While fRS2.EOF = False
            ...
            fJmlItem = IIf(IsNull(fRS2("JmlItem").Value), 0, fRS2("JmlItem").Value)
            fJmlHutangPenjaminDB = IIf(IsNull(fRS2("JmlHutangPenjaminDB").Value), 0, fRS2("JmlHutangPenjaminDB").Value)
            fJmlTanggunganRSDB = IIf(IsNull(fRS2("JmlTanggunganRSDB").Value), 0, fRS2("JmlTanggunganRSDB").Value)
            fJmlPembebasanDB = IIf(IsNull(fRS2("JmlPembebasanDB").Value), 0, fRS2("JmlPembebasanDB").Value)
            ...
            End If
            Set fRS3 = Nothing
            fQuery3 = "insert into RekapKomponenBiayaPelayananApotik values('" & fNoBKM & "','" & fKdBarang & "','" & fKdAsal & "','" & fKdRuangan & "','" & fSatuanJml & "','" & fKdKomponen & "'," & fJmlItem & "," & fHargaSatuanKomp & ",'" & fNoStruk & "'," & fJmlBayarPerKomp & "," & fJmlHutangPerKomp & "," & fJmlTanggunganPerKomp & "," & fJmlPembebasanPerKomp & "," & fSisaTagihanPerKomp & ",'" & fKdPelayananRS & "')"
...
Public Function f_AddRekapKomponenBiayaPelayananApotikClaim(fNoBKM As String, fNoBKMSebelumnya As String, fNoStruk As String, fJmlBayar As Currency)
    ...
    While fRS.EOF = False
        ...
        If fJmlHutangPenjaminL <> 0 Then
            ...
            Set fRS2 = Nothing
            fQuery2 = "insert into RekapKomponenBiayaPelayananApotik values('" & fNoBKM & "','" & fKdBarang & "','" & fKdAsal & "','" & fKdRuangan & "','" & fSatuanJml & "','" & fKdKomponen & "'," & fJmlBarang & "," & msubKonversiKomaTitik(CStr(fHargaSatuan)) & ",'" & fNoStruk & "'," & msubKonversiKomaTitik(CStr(fJmlBayarPerKomp)) & "," & msubKonversiKomaTitik(CStr(fJmlHutangPerKomp)) & "," & msubKonversiKomaTitik(CStr(fJmlTanggunganRSL)) & "," & msubKonversiKomaTitik(CStr(fJmlPembebasanL)) & "," & msubKonversiKomaTitik(CStr(fSisaTagihanL)) & ",'" & fKdPelayananRS & "')"
            Call msubRecFO(fRS2, fQuery2)
...
Public Function f_AddRekapKomponenBiayaPelayananApotikKredit(fNoBKM As String, fNoBKMSebelumnya As String, fNoStruk As String, fJmlBayar As Currency, fJmlPembebasan As Currency, fSisaTagihan As Currency)
    ...
    While fRS.EOF = False
        ...
        If fSisaTagihanL <> 0 Then
            ...
            Set fRS2 = Nothing
            fQuery2 = "insert into RekapKomponenBiayaPelayananApotik values('" & fNoBKM & "','" & fKdBarang & "','" & fKdAsal & "','" & fKdRuangan & "','" & fSatuanJml & "','" & fKdKomponen & "'," & fJmlBarang & "," & fHargaSatuan & ",'" & fNoStruk & "'," & fJmlBayarPerKomp & "," & fJmlHutangPenjaminL & "," & fJmlTanggunganRSL & "," & fJmlPembebasanPerKomp & "," & fSisaTagihanPerKomp & ",'" & fKdPelayananRS & "')"
            Call msubRecFO(fRS2, fQuery2)
...
Public Function f_AddRekapKomponenBiayaPelayananOAKredit(fNoBKM As String, fNoBKMSebelumnya As String, fNoStruk As String, fJmlBayar As Currency, fJmlPembebasan As Currency, fSisaTagihan As Currency)
    ...
    While fRS.EOF = False
        ...
        If fSisaTagihanL <> 0 Then
            ...
            fJmlBayarPerKomp = (CDec(fSisaTagihanL) / CDec(fTotalSisaTagihan)) * CDec(fJmlBayar)
            Set fRS2 = Nothing
            fQuery2 = "insert into RekapKomponenBiayaPelayananOA values('" & fNoBKM & "','" & fNoPendaftaran & "','" & fKdRuangan & "','" & fKdKelas & "','" & fKdKomponen & "','" & fKdBarang & "','" & fKdAsal & "'," & fJmlBarang & "," & fHargaSatuan & ",'" & Format(fTglPelayanan, "yyyy/MM/dd HH:mm:ss") & "','" & fNoStruk & "'," & fNoLab_Rad & "," & fIdPegawai & ",'" & fSatuanJml & "'," & fJmlBayarPerKomp & "," & fJmlHutangPenjaminL & "," & fJmlTanggunganRSL & "," & fJmlPembebasanPerKomp & "," & fSisaTagihanPerKomp & ",'" & fKdDetailJenisJasaPelayanan & "'," & fKdPaket & "," & fNoResep & ",'" & fKdPelayananRS & "','" & fKdSubInstalasi & "')"
            Call msubRecFO(fRS2, fQuery2)
...
Public Function f_AddRekapKomponenBiayaPelayananTMClaim(fNoBKM As String, fNoBKMSebelumnya As String, fNoStruk As String, fJmlBayar As Currency)
    ...
    While fRS.EOF = False
        ...
        If fJmlHutangPenjaminL <> 0 Then
            ...
            Set fRS2 = Nothing
            fQuery2 = "insert into RekapKomponenBiayaPelayananTM values('" & fNoBKM & "','" & fNoPendaftaran & "','" & fKdRuangan & "','" & fKdPelayananRS & "','" & fKdKomponen & "','" & fKdKelas & "'," & fJmlPelayanan & ",'" & Format(fTglPelayanan, "yyyy/MM/dd HH:mm:ss") & "'," & fTarif & "," & fNoLab_Rad & "," & fIdPegawai & ",'" & fNoStruk & "','" & fKdDetailJenisJasaPelayanan & "'," & msubKonversiKomaTitik(CStr(fJmlBayarPerKomp)) & "," & msubKonversiKomaTitik(CStr(fJmlHutangPenjaminPerKomp)) & "," & msubKonversiKomaTitik(CStr(fJmlTanggunganRSL)) & "," & msubKonversiKomaTitik(CStr(fJmlPembebasanL)) & "," & msubKonversiKomaTitik(CStr(fSisaTagihanL)) & "," & fKdPaket & ",'" & fKdSubInstalasi & "')"
            Call msubRecFO(fRS2, fQuery2)
...
Public Function f_AMDataTransaksiBarangMedis(fTglTransaksi As Date, fKdRuangan As String, fKdBarang As String, fKdAsal As String, fJmlBarang As Double, fHargaNetto As Currency, fHargaJual As Currency, fDiscount As Currency, fStatusTransaksi As String, fStatus As String)
    ...
    If fRS.EOF = True Then
        If LCase(fStatusTransaksi) = "i" Then
            fQuery = "insert into DataTransaksiBarangMedis values('" & Format(fTglTransaksi, "yyyy/MM/dd HH:mm:ss") & "','" & fKdRuangan & "','" & fKdBarang & "','" & fKdAsal & "'," & msubKonversiKomaTitik(CStr(fStokAwal)) & "," & msubKonversiKomaTitik(CStr(fJmlBarang)) & ",0," & msubKonversiKomaTitik(CStr(fJmlBarang)) & " * " & msubKonversiKomaTitik(CStr(fHargaNetto)) & ",0," & msubKonversiKomaTitik(CStr(fJmlBarang)) & " * " & msubKonversiKomaTitik(CStr(fDiscount)) & ",0,0,0,null)"
        Else
            fQuery = "insert into DataTransaksiBarangMedis values('" & Format(fTglTransaksi, "yyyy/MM/dd HH:mm:ss") & "','" & fKdRuangan & "','" & fKdBarang & "','" & fKdAsal & "'," & msubKonversiKomaTitik(CStr(fStokAwal)) & ",0," & msubKonversiKomaTitik(CStr(fJmlBarang)) & "," & msubKonversiKomaTitik(CStr(fJmlBarang)) & " * " & msubKonversiKomaTitik(CStr(fHargaNetto)) & ",0,0," & msubKonversiKomaTitik(CStr(fJmlBarang)) & " * " & msubKonversiKomaTitik(CStr(fHargaNetto)) & "," & msubKonversiKomaTitik(CStr(fJmlBarang)) & " * " & msubKonversiKomaTitik(CStr(fHargaJual)) & "," & msubKonversiKomaTitik(CStr(fJmlBarang)) & " * " & msubKonversiKomaTitik(CStr(fDiscount)) & ",null)"
        End If
    Else
        If UCase(fStatus) = "A" Then
            If LCase(fStatusTransaksi) = "i" Then
                fQuery = "update DataTransaksiBarangMedis set JmlTerima=JmlTerima + " & msubKonversiKomaTitik(CStr(fJmlBarang)) & ",TotalNettoi=TotalNettoi + (" & msubKonversiKomaTitik(CStr(fJmlBarang)) & " * " & msubKonversiKomaTitik(CStr(fHargaNetto)) & "),TotalDiscounti=TotalDiscounti + (" & msubKonversiKomaTitik(CStr(fJmlBarang)) & " * " & msubKonversiKomaTitik(CStr(fDiscount)) & ") where KdRuangan='" & fKdRuangan & "' and KdBarang='" & fKdBarang & "' and KdAsal='" & fKdAsal & "' and (datepart(hh, TglTransaksi)=datepart(hh, '" & Format(fTglTransaksi, "yyyy/MM/dd HH:mm:ss") & "') and day(TglTransaksi)=day('" & Format(fTglTransaksi, "yyyy/MM/dd HH:mm:ss") & "') and month(TglTransaksi)=month('" & Format(fTglTransaksi, "yyyy/MM/dd HH:mm:ss") & "') and year(TglTransaksi)=year('" & Format(fTglTransaksi, "yyyy/MM/dd HH:mm:ss") & "'))"
            Else
                fQuery = "update DataTransaksiBarangMedis set JmlKeluar=JmlKeluar + " & msubKonversiKomaTitik(CStr(fJmlBarang)) & ",TotalNettoo=TotalNettoo + (" & msubKonversiKomaTitik(CStr(fJmlBarang)) & " * " & msubKonversiKomaTitik(CStr(fHargaNetto)) & "),TotalJualo=TotalJualo + (" & msubKonversiKomaTitik(CStr(fJmlBarang)) & " * " & msubKonversiKomaTitik(CStr(fHargaJual)) & "),TotalDiscounto=TotalDiscounto + (" & msubKonversiKomaTitik(CStr(fJmlBarang)) & " * " & msubKonversiKomaTitik(CStr(fDiscount)) & ") where KdRuangan='" & fKdRuangan & "' and KdBarang='" & fKdBarang & "' and KdAsal='" & fKdAsal & "' and (datepart(hh, TglTransaksi)=datepart(hh, '" & Format(fTglTransaksi, "yyyy/MM/dd HH:mm:ss") & "') and day(TglTransaksi)=day('" & Format(fTglTransaksi, "yyyy/MM/dd HH:mm:ss") & "') and month(TglTransaksi)=month('" & Format(fTglTransaksi, "yyyy/MM/dd HH:mm:ss") & "') and year(TglTransaksi)=year('" & Format(fTglTransaksi, "yyyy/MM/dd HH:mm:ss") & "'))"
            End If
        Else
            If LCase(fStatusTransaksi) = "i" Then
                fQuery = "update DataTransaksiBarangMedis set JmlTerima=JmlTerima - " & msubKonversiKomaTitik(CStr(fJmlBarang)) & ",TotalNettoi=TotalNettoi - (" & msubKonversiKomaTitik(CStr(fJmlBarang)) & " * " & msubKonversiKomaTitik(CStr(fHargaNetto)) & "),TotalDiscounti=TotalDiscounti - (" & msubKonversiKomaTitik(CStr(fJmlBarang)) & " * " & msubKonversiKomaTitik(CStr(fDiscount)) & ") where KdRuangan='" & fKdRuangan & "' and KdBarang='" & fKdBarang & "' and KdAsal='" & fKdAsal & "' and (datepart(hh, TglTransaksi)=datepart(hh, '" & Format(fTglTransaksi, "yyyy/MM/dd HH:mm:ss") & "') and day(TglTransaksi)=day('" & Format(fTglTransaksi, "yyyy/MM/dd HH:mm:ss") & "') and month(TglTransaksi)=month('" & Format(fTglTransaksi, "yyyy/MM/dd HH:mm:ss") & "') and year(TglTransaksi)=year('" & Format(fTglTransaksi, "yyyy/MM/dd HH:mm:ss") & "'))"
...
Public Function f_AddPembatalanStrukPelayananKasir(fNoBKM As String, fNoStruk As String, fPembayaranKe As Integer, fKdRuangan As String, fIdUser As String)
    ...
    If fPembayaranKe = 1 And fMaxPembayaranKe = 1 Then
        ...
        Call msubRecFO(fRS, fQuery)
        Set fRS = Nothing
        fQuery = "delete from StrukPelayananPasien where NoStruk='" & fNoStruk & "' "
        Call msubRecFO(fRS, fQuery)
