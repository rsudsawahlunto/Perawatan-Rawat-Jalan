...
Begin VB.Form frmKirimTerimaDokumen 
   ...
   Caption         =   " Kirim Terima Dokumen Rekam Medis"
   ClientHeight    =   5145
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   13935
...
Private Sub dcRuanganTujuan_KeyPress(KeyAscii As Integer)
    If KeyAscii = 13 Then
        ...
        strSQL = "SELECT KdRuangan, NamaRuangan FROM  Ruangan  WHERE NamaRuangan LIKE '%" & dcRuanganTujuan.Text & "%' and StatusEnabled='1' ORDER BY NamaRuangan"
        Call msubRecFO(rs, strSQL)
        If rs.EOF = True Then
            dcRuanganTujuan.Text = ""
'            txtKeteranganKirim.SetFocus
            Exit Sub
        End If
...
If dcRuanganTujuan.MatchedWithList = False Then dcRuanganTujuan.Text = ""
End Sub
...
Private Sub dcUserKirim_LostFocus()
If dcUserKirim.MatchedWithList = False Then dcUserKirim.Text = ""
End Sub
...
Private Sub dcUserTerima_LostFocus()
If dcUserTerima.MatchedWithList = False Then dcUserTerima.Text = ""
End Sub
...
Private Sub txtJK_KeyPress(KeyAscii As Integer)
    ...
    If KeyAscii = 13 Then txtRuanganPelayanan.SetFocus
End Sub

Private Sub txtKeteranganKirim_KeyPress(KeyAscii As Integer)
    If KeyAscii = 13 Then dcUserKirim.SetFocus
    Call SetKeyPressToChar(KeyAscii)
End Sub

Private Sub txtKeterangaTerima_KeyPress(KeyAscii As Integer)
    If KeyAscii = 13 Then dcUserTerima.SetFocus
    Call SetKeyPressToChar(KeyAscii)
End Sub
...
Private Sub txtRuanganPelayanan_KeyPress(KeyAscii As Integer)
    Call SetKeyPressToChar(KeyAscii)
    If KeyAscii = 13 Then dtpTglKirim.SetFocus
End Sub
