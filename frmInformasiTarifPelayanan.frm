...
Begin VB.Form frmInformasiTarifPelayanan 
   ...
   Begin VB.Image Image2 
      Height          =   945
      Left            =   9360
      Picture         =   "frmInformasiTarifPelayanan.frx":368B
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1875
   End
...
Private Sub cmdCari_Click()
    ...
    " From V_InfoTarifPelayananPerRuangan" & _
    " WHERE [Nama Pelayanan] LIKE '%" & txtNamaPemeriksaan.Text & "%' AND [Kelas Pelayanan] LIKE '%" & txtKelasPelayanan.Text & "%'" & _
    " AND KdRuangan='" & mstrKdRuangan & "' ORDER BY [Jenis Pelayanan], [Nama Pelayanan]"
...
Private Sub cmdCetak_Click()
    ...
    mstrFilter = ""
    strSQL = "SELECT * " & _
    " From V_InfoTarifPelayananPerRuangan WHERE KdRuangan='" & mstrKdRuangan & "' AND [Nama Pelayanan] LIKE '%" & txtNamaPemeriksaan.Text & "%' AND [Kelas Pelayanan] LIKE '%" & txtKelasPelayanan.Text & "%'" & _
    " "
    Set rs = Nothing
    ...
    If rs.RecordCount = 0 Then
        ...
        Exit Sub
    End If
    mstrFilter = " WHERE KdRuangan='" & mstrKdRuangan & "' AND [Nama Pelayanan] LIKE '%" & txtNamaPemeriksaan.Text & "%' AND [Kelas Pelayanan] LIKE '%" & txtKelasPelayanan.Text & "%'"
    Call msubPesanCetak
