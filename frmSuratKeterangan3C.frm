...
Private Sub txtNoCM_KeyPress(KeyAscii As Integer)
    ...
    If KeyAscii = 13 Then txtNoRontgen.SetFocus
End Sub

Private Sub txtNoRontgen_KeyPress(KeyAscii As Integer)
    If KeyAscii = 13 Then txtKiriman.SetFocus
    Call SetKeyPressToNumber(KeyAscii)
End Sub
...
Private Sub txtSex_KeyPress(KeyAscii As Integer)
    If KeyAscii = 13 Then txtPekerjaan.SetFocus
    Call SetKeyPressToChar(KeyAscii)
End Sub
...
Private Sub txtUmur_KeyPress(KeyAscii As Integer)
    If KeyAscii = 13 Then txtSex.SetFocus
    Call SetKeyPressToNumber(KeyAscii)
End Sub
