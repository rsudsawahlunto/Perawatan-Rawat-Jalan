...
Begin VB.Form frmKonfirmasiPenerimaanBarang 
   ...
   EndProperty
   Icon            =   "frmKonfirmasiPenerimaanBarang.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VB.Image Image2 
      Height          =   945
      Left            =   10680
      Picture         =   "frmKonfirmasiPenerimaanBarang.frx":0CCA
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1875
   End
   Begin VB.Image Image1 
      Height          =   975
      Left            =   1800
      Picture         =   "frmKonfirmasiPenerimaanBarang.frx":1A52
      Stretch         =   -1  'True
      Top             =   0
      Width           =   10695
   End
   ...
   End
End
Attribute VB_Name = "frmKonfirmasiPenerimaanBarang"
...
On Error GoTo hell
    ...
    With dbcmd
        ...
        .Parameters.Append .CreateParameter("NoTerimaFifo", adChar, adParamInput, 10, f_NoTerima)
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    frmInfoPesanBarang.cmdTampilkan_Click
End Sub
