...
Begin VB.Form frmKonsul_OrderPelayanan 
   ...
   Begin VB.Frame fraDokter2 
      ...
      Visible         =   0   'False
      Width           =   5655
      Begin MSDataGridLib.DataGrid dgDokter2 
         Height          =   2415
         Left            =   120
         TabIndex        =   120
         Top             =   120
      ...
      End
   End
   Begin VB.TextBox txtKdDokterDelegasi 
      Alignment       =   2  'Center
      Appearance      =   0  'Flat
      Enabled         =   0   'False
      Height          =   330
      ...
      Width           =   1575
   End
   Begin VB.Frame fraDokterDelegasi 
      Height          =   2655
      Left            =   3120
      TabIndex        =   116
      Top             =   2640
      Visible         =   0   'False
      Width           =   5655
      Begin MSDataGridLib.DataGrid dgDokterDelegasi 
         Height          =   2415
         Left            =   120
         TabIndex        =   117
         Top             =   120
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Begin VB.Frame Frame1 
         ...
         Top             =   4155
         Width           =   13455
         Begin VB.TextBox txtKdPelayanan 
            Alignment       =   2  'Center
            Appearance      =   0  'Flat
            Enabled         =   0   'False
            Height          =   330
      ...
      Begin VB.Frame Frame4 
         ...
         Begin VB.Label Label6 
            AutoSize        =   -1  'True
            Caption         =   "Instalasi Tujuan Konsul"
            Height          =   210
            Left            =   120
            TabIndex        =   13
            Top             =   840
...
Else
    ...
    txtKdDokterDelegasi.Text = ""
    fraDokterDelegasi.Visible = False
End If
End Sub
...
If KeyAscii = 13 Then
    If chkDibayardimuka.Value = vbChecked Then chkDilayaniDokter.SetFocus Else txtIsiTM.SetFocus
End If
...
Private Sub chkDokterResusitasi_KeyPress(KeyAscii As Integer)
    If KeyAscii = 13 Then chkAsisten.SetFocus
End Sub

Private Sub chkInstrumen_KeyPress(KeyAscii As Integer)
    If KeyAscii = 13 Then ChkSirkuler.SetFocus
End Sub

Private Sub ChkSirkuler_KeyPress(KeyAscii As Integer)
...
On Error GoTo errLoad
    ...
    If strCito = "Y" Or strCito = "1" Then
        strNStsCITO = "Ya"
    ElseIf strCito = "T" Or strCito = "0" Then
        strNStsCITO = "Tidak"
    End If
    strNamaRuangan = dcRuangan.Text
    mstrNama = dcDokterPerujuk.Text
    mstrNoOrder = txtNoOrder1.Text
    If optVerifikasi.Value = True Then
        strCetak = "0"
    Else
        strCetak = "1"
    End If
...
mstrKdKelasDitanggung = dcKelas.BoundText
End Sub

Private Sub dcRuangan_Change()
    If dcRuangan.BoundText = "401" Then
        dcKelas.Visible = True
        Label8.Visible = True
        
        ' @503 (2014-11-09)
    ' Penambahan Kelas Tanggungan Penjamin Pada Pasien Konsul
    
'    strSQL2 = "SELECT Top 1 KelasPelayanan.KdKelas, KelasPelayanan.DeskKelas FROM KelasPelayanan INNER JOIN PemakaianAsuransi ON KelasPelayanan.KdKelas = PemakaianAsuransi.KdKelasDiTanggung WHERE NoPendaftaran='" & mstrNoPen & "'"
'    Set rs2 = Nothing
'    rs2.Open strSQL2, dbConn, adOpenForwardOnly, adLockReadOnly
'    If rs2.RecordCount <> 0 Then
'        mstrKdKelasDitanggung = rs2(0)
'        dcKelas.BoundColumn = rs2(0)
'        dcKelas.Text = rs2(1)
'    End If
...
If KeyAscii = 13 Then
    strSQL = "SELECT KodeDokter,NamaDokter FROM V_DaftarDokter where KodeDokter = '" & dgDokter.Columns(0).Value & "' "
    Call msubRecFO(rs, strSQL)
    If rs.EOF = False Then
        txtKdDokter.Text = rs.Fields(0)
        mstrKdDokter = txtKdDokter.Text
        txtDokter.Text = rs("NamaDokter")
    End If
...
Private Sub dgDokter2_DblClick()
    Call dgDokter2_KeyPress(13)
End Sub

Private Sub dgDokter2_KeyPress(KeyAscii As Integer)
If KeyAscii = 13 Then
    strSQL = "SELECT KodeDokter,NamaDokter FROM V_DaftarDokter where KodeDokter = '" & dgDokter2.Columns(0).Value & "' "
    Call msubRecFO(rs, strSQL)
    If rs.EOF = False Then
        txtKdDokter2.Text = rs.Fields(0)
'        mstrKdDokter2 = txtKdDokter.Text
        txtDokter2.Text = rs("NamaDokter")
    End If
    fraDokter2.Visible = False
'    If dcInstalasi.BoundText = "04" Then
'        chkPerawat.SetFocus
'    Else
'        chkDelegasi.SetFocus
...
Private Sub dgDokterDelegasi_DblClick()
    Call dgDokterDelegasi_KeyPress(13)
End Sub

Private Sub dgDokterDelegasi_KeyPress(KeyAscii As Integer)
If KeyAscii = 13 Then
    strSQL = "SELECT KodeDokter,NamaDokter FROM V_DaftarDokter where KodeDokter = '" & dgDokterDelegasi.Columns(0).Value & "' "
    Call msubRecFO(rs, strSQL)
    If rs.EOF = False Then
        txtKdDokterDelegasi.Text = rs("KodeDokter")
        mstrKdDokterD = txtKdDokterDelegasi.Text
        txtDokterDelegasi.Text = rs("NamaDokter")
    End If
    fraDokterDelegasi.Visible = False
    txtIsiTM.SetFocus
End If
...
Private Sub optLangsung_KeyPress(KeyAscii As Integer)
If KeyAscii = 13 Then
    txtIsiTM.SetFocus
End If
End Sub
...
Private Sub optVerifikasi_KeyPress(KeyAscii As Integer)
If KeyAscii = 13 Then txtIsiTM.SetFocus
End Sub
...
On Error GoTo hell
    ...
    If dcDokterPerujuk.Text = "" Then
        MsgBox "Dokter Perujuk kosong ", vbCritical, "Validasi"
...
'    End If
    ...
    If fgPelayanan.TextMatrix(1, 0) <> "" Then
     If MsgBox("Apakah semua pelayanan dalam status CITO?" & vbNewLine & "Pilih YES Jika Ingin CITO", vbYesNo, "Medifirst2000 - Status CITO") = vbYes Then strCito = "1"
    End If
    ...
    For i = 1 To fgPelayanan.Rows - 2
        ...
        ''proses simpan pasien konsul/pasien rujukan
'        If sp_PasienRujukanNStrukOrder(fgPelayanan.TextMatrix(i, 18), fgPelayanan.TextMatrix(i, 19), fgPelayanan.TextMatrix(i, 20), fgPelayanan.TextMatrix(i, 21), fgPelayanan.TextMatrix(i, 22)) = False Then Exit Sub
lanjut_:

         fgPelayanan.TextMatrix(i, 7) = strCito
...
Private Function sp_PasienRujukanNStrukOrder() As Boolean
On Error GoTo hell
...
Set dbcmd = New ADODB.Command
    With dbcmd
        ...
        .Parameters.Append .CreateParameter("KdJenisOperasi", adChar, adParamInput, 2, IIf(dcJenisOperasi.BoundText = "", Null, dcJenisOperasi.BoundText))
        If dcRuangan.BoundText = "401" Then
        .Parameters.Append .CreateParameter("KdKelas", adChar, adParamInput, 2, mstrKdKelasDitanggung)
        Else
        .Parameters.Append .CreateParameter("KdKelas", adChar, adParamInput, 2, mstrKdKelas)
        End If
        .Parameters.Append .CreateParameter("IdUser", adChar, adParamInput, 10, strIDPegawaiAktif)
        If optVerifikasi.Value = True Then
        .Parameters.Append .CreateParameter("StatusBayarDimuka", adChar, adParamInput, 1, "T")
        Else
        .Parameters.Append .CreateParameter("StatusBayarDimuka", adChar, adParamInput, 1, "Y")
        End If
        .ActiveConnection = dbConn
        .CommandText = "dbo.Add_PasienRujukanDibayarDimuka"
        .CommandType = adCmdStoredProc
        .Execute
...
On Error GoTo errLoad
    ...
    With dbcmd
        ...
        .Parameters.Append .CreateParameter("NoPendaftaran", adChar, adParamInput, 10, mstrNoPen)
        .Parameters.Append .CreateParameter("IdDokterOrder", adChar, adParamInput, 10, f_idDokterPerujuk)
        ...
        .Parameters.Append .CreateParameter("KdKelas", adChar, adParamInput, 2, mstrKdKelas)
        End If
        .Parameters.Append .CreateParameter("IdPegawai", adChar, adParamInput, 10, f_idDokterPerujuk)
        ...
        Else
        .Parameters.Append .CreateParameter("StatusDokterBersama", adChar, adParamInput, 1, fStatusDelegasi)
        End If
...
Private Sub txtDokterDelegasi_Change()
    ...
    mstrFilterDokter = "WHERE NamaDokter like '%" & txtDokterDelegasi.Text & "%'"
    fraDokterDelegasi.Visible = True
...
If KeyAscii = 13 Then
        ...
        If fraDokterDelegasi.Visible = True Then
            dgDokterDelegasi.SetFocus
        Else
            If chkPerawat.Enabled = True Then
            chkPerawat.SetFocus
            Else
            txtIsiTM.SetFocus
            End If
...
Private Sub txtKuantitas_KeyPress(KeyAscii As Integer)
  '  If KeyAscii = 13 Then optCito(1).SetFocus
...
If txtKuantitas.Text = "" Or txtKuantitas.Text = "0" Then
  MsgBox "Jumlah Pelayanan Harus Di isi Terlebih Dahulu", vbInformation, "Medifirst2000"
  txtKuantitas.SetFocus
  Exit Sub
End If

If txtIsiTM.Text = "" Then
    MsgBox "Pelayanan Harus Di isi Terlebih Dahulu", vbInformation, "Medifirst2000"
    txtIsiTM.SetFocus
Else
Dim subcurTarifBiayaSatuan As Currency
    dTglPlyn = Now
...
'    End If
    ...
    For j = 1 To fgPelayanan.Rows - 1
        If fgPelayanan.TextMatrix(j, 0) = txtKdPelayanan.Text Then
            MsgBox "Nama Pelayanan sudah di input", vbExclamation, "Validasi": Exit Sub
        End If
    Next j
    ...
    With fgPelayanan
      max_i = .Rows
        ...
        If optCito(0).Value = True Then strCito = "Y" Else strCito = "T"
        ...
        .TextMatrix(i, 19) = dcDokterPerujuk.BoundText
        .TextMatrix(i, 20) = dtpTglOrderTM.Value
        .TextMatrix(i, 21) = dcJenisOperasi.BoundText
        .TextMatrix(i, 22) = IIf(chkDibayardimuka.Value = vbChecked, "Y", "T")
...
On Error GoTo errLoad
    txtKdPelayanan.Text = dgPelayananRS.Columns(1).Value
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    If txtNamaForm.Text = "frmDaftarPasienRJ" Then
        frmDaftarPasienRJ.Enabled = True
        frmTransaksiPasien.Enabled = True
    ElseIf txtNamaForm.Text = "frmDaftarPasienRI" Then
        frmDaftarPasienRI.Enabled = True
    ElseIf txtNamaForm.Text = "frmDaftarPasienGD" Then
        frmDaftarPasienGD.Enabled = True
    ElseIf txtNamaForm.Text = "frmTransaksiPasien" Then
        frmTransaksiPasien.Enabled = True
    End If
...
On Error GoTo errLoad
    ...
    Call msubDcSource(dcKelas, rs, "SELECT KdKelas, DeskKelas FROM KelasPelayanan where kdKelas <> '07'")
...
On Error GoTo errLoad
    ...
    With dgDokterDelegasi
        ...
        .Columns(3).Width = 3000
    End With
    fraDokterDelegasi.Left = 360
    fraDokterDelegasi.Top = 3360
...
On Error GoTo hell
    If dcRuangan.BoundText = "401" Then
        strSQL = "SELECT DISTINCT TOP (200) [Jenis Pelayanan], KdPelayananRS, [Nama Pelayanan] as NamaPelayanan, Tarif" & _
                " FROM V_TarifPelayananTindakan where Kdruangan='" & dcRuangan.BoundText & "' AND [Nama Pelayanan] like'%" & txtIsiTM.Text & "%' AND KdPelayananRS IS NOT NULL and kdKelas= '" & mstrKdKelasDitanggung & "' order by NamaPelayanan"
        Else
    strSQL = "SELECT DISTINCT TOP (200) [Jenis Pelayanan], KdPelayananRS, [Nama Pelayanan] as NamaPelayanan, Tarif" & _
            " FROM V_TarifPelayananTindakan where Kdruangan='" & dcRuangan.BoundText & "' AND [Nama Pelayanan] like'%" & txtIsiTM.Text & "%' AND KdPelayananRS IS NOT NULL and kdKelas='" & mstrKdKelas & "' order by NamaPelayanan"
    End If
