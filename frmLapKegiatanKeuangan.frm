...
Begin VB.Form frmLapKegiatanKeuangan 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Medifirst2000 - Laporan Kegiatan Keuangan Poliklinik Rawat Jalan"
   ClientHeight    =   8310
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   14925
   ...
   EndProperty
   Icon            =   "frmLapKegiatanKeuangan.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VB.Image Image3 
      Height          =   975
      Left            =   0
      Picture         =   "frmLapKegiatanKeuangan.frx":0CCA
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1800
   End
   Begin VB.Image Image2 
      Height          =   945
      Left            =   13080
      Picture         =   "frmLapKegiatanKeuangan.frx":368B
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1875
   End
   Begin VB.Image Image1 
      Height          =   975
      Left            =   1800
      Picture         =   "frmLapKegiatanKeuangan.frx":4413
      Stretch         =   -1  'True
      Top             =   0
      Width           =   13215
   End
End
Attribute VB_Name = "frmLapKegiatanKeuangan"
...
Public Sub subLoadGridSource()
    ...
    If optTindakanMedis.Value = True Then
        frmLapKegiatanKeuangan.Caption = "Data Pelayanan Kegiatan Keuangan Tindakan Medis"
        strSQL = "SELECT  TglPelayanan, JenisPasien, Kelas, NoPendaftaran, NoCM, NamaPasien, JK, JenisItem, NamaItem, JmlItem, HargaSatuan, HargaCito, TotalBiaya, Ruangan," & _
        " AsalPasien , NoClosing, KdItem,  KdAsal, NoLab_Rad, DokterOperator, JmlHutangPenjamin, JmlTanggunganRS FROM V_DaftarDataPelayananLapKegiatanKeuangan" & _
    ...
    ElseIf optObatAlKes.Value = True Then
        frmLapKegiatanKeuangan.Caption = "Data Pelayanan Obat AlKes"
    ...
    ElseIf optApotik.Value = True Then
        frmLapKegiatanKeuangan.Caption = "Data Pelayanan Apotik"
...
Private Sub cmdClosingData_Click()
    ...
    MsgBox "" & frmLapKegiatanKeuangan.Caption & " Berhasil ", vbInformation, "Informasi"
    pbData.Value = 0
    cmdClosingData.Enabled = True
...
Private Sub dgClosingDataPelayananTM_OA_Apotik_Click()
    WheelHook.WheelUnHook
    Set MyProperty = dgClosingDataPelayananTM_OA_Apotik
    WheelHook.WheelHook dgClosingDataPelayananTM_OA_Apotik
End Sub
...
Private Sub DTPTglClosing_KeyDown(KeyCode As Integer, Shift As Integer)
...
Private Sub Form_KeyDown(KeyCode As Integer, Shift As Integer)
    If KeyCode = vbKeyF1 Then
        ...
        frmCetakLapKegiatanKeuangan.Show
    End If
...
Private Sub Form_Load()
    ...
    strSQL = "SELECT KdInstalasi FROM Ruangan WHERE KdRuangan ='" & mstrKdRuangan & "'  and StatusEnabled='1'"
    Set rs = Nothing
