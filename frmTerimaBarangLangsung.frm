...
Private Sub dcStatusBarang_KeyPress(KeyAscii As Integer)
    If KeyAscii = 13 Then dcRuanganPengirim.SetFocus
End Sub
...
'Dim tempDiscount As String
    With fgData
        ...
        .TextMatrix(.Row, 5) = 0
        .TextMatrix(.Row, 6) = IIf(dgObatAlkes.Columns("Harga Satuan") = "", 0, dgObatAlkes.Columns("Harga Satuan"))
        .TextMatrix(.Row, 7) = 0
...
If dcStatusBarang.BoundText = "02" Then
    Select Case fgData.Col
        ...
        Case 1 'nama barang
                strSQL = "select DISTINCT TOP 100 [Nama Barang], [Asal Barang], [Jenis Barang], Satuan, JmlStok, KdBarang, KdSatuanJmlB, Kekuatan, KdAsal, HargaNetto" & _
                    " from V_AmbilStockBarang" & _
...
ElseIf dcStatusBarang.BoundText = "01" Then
    Select Case fgData.Col
        ...
        Case 1 'nama barang
                strSQL = "Select TOP (100) PERCENT NamaBarang as [Nama Barang], NamaAsal as [Asal Barang], DetailJenisBarang as [Jenis Barang], SatuanJmlB as Satuan, JmlStok, HargaNetto as [Harga Satuan], KdBarang, KdAsal, KdRuangan, KdSatuanJmlB " & _
                    " from V_AmbilStockBarangNonMedis " & _
                    " where NamaBarang like '%" & txtIsi.Text & "%' AND KdRuangan = '" & dcRuanganPengirim.BoundText & "' ORDER BY NamaBarang"
            
            Call msubRecFO(dbRst, strSQL)
            Set dgObatAlkes.DataSource = dbRst
            With dgObatAlkes
                .Columns("Jenis Barang").Width = 0 '1250
                .Columns("Asal Barang").Width = 1500 '1250
                .Columns("Nama Barang").Width = 3900
                .Columns("Satuan").Width = 0
                '.Columns("Kekuatan").Width = 1150
                .Columns("KdBarang").Width = 1250
