...
Begin VB.Form frm_cetak_RincianBiayaPenjamin 
   Caption         =   "Cetak Laporan Cetak Rincian Biaya Sementara"
   ClientHeight    =   7065
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   5805
   Icon            =   "frm_cetak_RincianBiayaPenjamin.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   7065
   ScaleWidth      =   5805
   ...
   End
End
Attribute VB_Name = "frm_cetak_RincianBiayaPenjamin"
...
Dim Report As New cr_RincianBiayaPenjamin
...
Private Sub Form_Load()
    ...
    With Report
        ...
        .ucPiutangPenjamin.SetUnboundFieldSource ("{ado.TotalHutangPenjamin}")
        .ucPiutangRS.SetUnboundFieldSource ("{ado.TotalTanggunganRS}")
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Set frm_cetak_RincianBiayaPenjamin = Nothing
    Set rs = Nothing
